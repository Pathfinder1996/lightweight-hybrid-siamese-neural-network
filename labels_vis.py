...
for fold, (train_idx, val_idx) in enumerate(kf.split(pairs_1, labels)):
    ...
    for i in sample_idx_list:
        ...
        output = np.full((64 + 2*border_size, 128 + 2*border_size, 3), 255, dtype="uint8")
        ...
        output[border_size:-border_size, border_size:64+border_size, :] = imageA_3c
        output[border_size:-border_size, 64+border_size:128+border_size, :] = imageB_3c
